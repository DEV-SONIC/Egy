...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./EGY.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("NG", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/div-sonic/Files_EGY/main/File_Bot/commands.lua") 
...
EGY_Msg = 'زعيم التفاعل' 
elseif msgs < 4500 then 
EGY_Msg = 'مدمن تفاعل' 
elseif msgs < 5000 then 
EGY_Msg = 'جامد ف التفاعل' 
elseif msgs < 7000 then 
EGY_Msg = 'اكبر الملوك' 
elseif msgs < 9500 then 
EGY_Msg = 'بطللللل التفاعل' 
elseif msgs < 10000000000 then 
EGY_Msg = 'انت التفاعل نفسوو'
end 
return EGY_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceEGY(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,EGY_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf EGY.lua')
os.execute('wget https://raw.githubusercontent.com/div-sonic/Egy/main/EGY.lua')
...
send(msg.chat_id_, msg.id_,'عدد المجموعات الان » { '..#group..' }'..EGYk..''..EGY..'\n  الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعه\n')   
end
end
end,nil)
end
...
local EGY1_Msg = database:get(bot_id.."EGY1:Add:Filter:Rp2"..text..msg.chat_id_)   
if EGY1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if EGY_Msg and not Special(msg) then  
local EGY_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if EGY_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:set(bot_id.."EGY:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."EGY:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."EGY:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."EGY:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."EGY:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."EGY:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."EGY:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."EGY:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."EGY:age_Bots"..msg.chat_id_) == "open" then
...
database:sadd(bot_id.."EGY:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."EGY:blocname"..msg.chat_id_)
...
if name_Black then 
names_Black = database:smembers(bot_id.."EGY:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."EGY:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."EGY:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."EGY:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."EGY:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."EGY:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function keko_tsahke_new(tshake1,tshake2)
if tshake2 and tshake2.first_name_ then 
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."EGY:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."EGY:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."EGY:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."EGY:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(tshake_nnn2) == tonumber(tshake_nnn) or tonumber(tshake_nnn2) ← tonumber(tshake_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."EGY:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "•عزيزي ←←["..tshake2.username_.."](https://t.me/"..(tshake2.username_ or "Revorb0t")..")\n•عليك وضع التوحيد ⪼ {`"..database:get(bot_id.."EGY:teh"..msg.chat_id_).."`} بجانب اسمك\n•عدد المحاولات المتبقيه {"..(tonumber(tshake_nnn) - tonumber(tshake_nnn2)).."}")
end
end
end
end
...
local EGYChengName = database:get(bot_id.."EGY:Cheng:Name"..data.id_)
if not data.first_name_ then 
if EGYChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..EGYChengName..']')
database:del(bot_id.."EGY:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if EGYChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."EGY:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local EGYChengUserName = database:get(bot_id.."EGY:Cheng:UserName"..data.id_)
if not data.username_ then 
if EGYChengUserName then 
send(msg.chat_id_, msg.id_, 1, "هذا الشخص حذف معرفه      \n هاذه معرفه  : [@"..EGYChengUserName..']')
database:del(bot_id.."EGY:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if EGYChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."EGY:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local EGYChengPhoto = database:get(bot_id.."EGY:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if EGYChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."EGY:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if EGYChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ايه الصوره القمر دي ",
...
database:set(bot_id.."EGY:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/div-sonic/Files_EGY/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/div-sonic/Files_EGY/main/File_Bot/"..file)
if res == 200 then
...
-----------------------------------------------------
if text == ("تاك للملود") and Mod(msg) then
...
database:set(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."EGY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."EGY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"•تم منع الكلمه مع التحذير")  
database:del(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."EGY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."EGY1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."EGY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"•ارسل الكلمه الان")  
database:set(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."EGY1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."EGY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."EGY1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."EGY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."EGY1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."EGY1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n•قائمة المنع \n *܀⠤⠤⠤⠤⠤⠤܀ٴ*\n"
for k,v in pairs(list) do  
local EGY_Msg = database:get(bot_id.."EGY1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ← {"..EGY_Msg.."}\n"    
end  
if #list == 0 then  
...
if not database:get(bot_id..'EGY:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'EGY:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..EGY_Msg[math.random(#EGY_Msg)]..']') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'EGY')..') '
...
-- vardump(data) 
EGYdx(msg.chat_id_, msg.id_, '• ايدي المجموعة ← ( '..msg.chat_id_..' )\n عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n• عدد المحظورين ← ( *'..data.kicked_count_..' )*\n• عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
------------------------------------------------------------------------
local EGYAbot = database:get(bot_id.."EGY1:Add:Filter:Rp2"..text..result.chat_id_)   
if EGYAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
------------------------------------------------------------------------
if text then
local EGY1_Msg = database:get(bot_id.."EGY1:Add:Filter:Rp2"..text..result.chat_id_)   
if EGY1_Msg then    
send(msg.chat_id_, msg.id_,"•"..EGY1_Msg)
